...
from NeuralNetwork1_MultiUnetModel import multi_unet_model #Uses softmax 
...
train_images = []
with tifffile.TiffFile("images_as_128x128_patches.tif") as tiff:
...
train_masks = [] 
with tifffile.TiffFile("masks_as_128x128_patches.tif") as tiff:
	# Iterate through all pages
	for page in tiff.pages:
		# Access the page data as a NumPy array
		mask = page.asarray()
		#mask = cv2.imread(page, 0)	   
